...
ActiveRecord::Schema.define(version: 20180225022124) do
  ...
  create_table "kokoa", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.datetime "invasion_time"
    t.string "invasion_location", limit: 16
  end
